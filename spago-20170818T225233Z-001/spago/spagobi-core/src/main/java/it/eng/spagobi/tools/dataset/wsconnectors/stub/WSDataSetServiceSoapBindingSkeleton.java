...
public class WSDataSetServiceSoapBindingSkeleton implements it.eng.spagobi.tools.dataset.wsconnectors.stub.IWsConnector, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    public java.lang.String readDataSet(java.lang.String in0, java.util.Map in1, java.lang.String in2,java.lang.String in3, java.lang.String in4, java.lang.String in5) throws java.rmi.RemoteException
    {
        java.lang.String ret = impl.readDataSet(in0, in1, in2, in3, in4, in5);
        return ret;
    }
