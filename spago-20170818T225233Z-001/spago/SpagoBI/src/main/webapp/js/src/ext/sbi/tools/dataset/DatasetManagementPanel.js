		...
		.extend(
				...
				Sbi.widgets.ListDetailForm,
				{
					...
					initTypeTab : function() {
						...
						this.detailWsAddress = new Ext.form.TextArea({
							maxLength : 250,
							minLength : 1,
							width : 350,
							xtype : 'textarea',
						...
						//added by rg8981
						this.detailEndPoint = new Ext.form.TextField({
							maxLength : 50,
							minLength : 1,
							width : 350,
							regexText : LN('sbi.roles.alfanumericString'),
							fieldLabel : LN('sbi.ds.wsEndPoint'),
							allowBlank : true,
							validationEvent : true,
							name : 'wsOperation'
						});
						
						this.detailRequest = new Ext.form.TextField({
							maxLength : 50,
							minLength : 1,
							width : 350,
							regexText : LN('sbi.roles.alfanumericString'),
							fieldLabel : LN('sbi.ds.wsRequest'),
							allowBlank : true,
							validationEvent : true,
							name : 'wsOperation'
						});
