...
//		}
	...
	,cleanCacheBeforeRefresh : function(){
    	// ids of data store
    	...
    	Ext.Ajax.request({
		    ...
		    success : function(){
		    	Sbi.trace("[StoreManager.cleanCacheBeforeRefresh]: success");
				//Sbi.exception.ExceptionHandler.showInfoMessage(LN('sbi.cockpit.storeManager.cacheCleaned'), 'Info');
		    },
			failure: function(){
				Sbi.trace("[StoreManager.cleanCacheBeforeRefresh]: failure");
	...
	,cleanCacheForRefresh : function(){
    	...
    	Ext.Ajax.request({
		    ...
		    success : function(){
		    	Sbi.trace("[StoreManager.cleanCacheForRefresh]: success");
				//Sbi.exception.ExceptionHandler.showInfoMessage(LN('sbi.cockpit.storeManager.cacheCleaned'), 'Info');
		    },
			failure: function(){
				Sbi.trace("[StoreManager.cleanCacheForRefresh]: failure");
				//Sbi.exception.ExceptionHandler.showErrorMessage(LN('sbi.cockpit.storeManager.errorInCleaningCache'), 'Service Error');
				},
			scope: this
		});
